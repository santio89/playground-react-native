                ...
                <View style={[styles.itemsContainer, altColorTheme && styles.altItemsContainer]}>
                    ...
                    {Platform.OS === 'web' &&
                        <View style={styles.settingsItem}>
                            ...
                            <View style={[styles.settingsItemTextWrapper]}>
                                <TouchableOpacity onPress={() => { Linking.openURL("https://drive.google.com/uc?export=download&id=1T5QwQMRG1BhSh_jIypiCPiQh10CXqLCt") }} style={[styles.settingsItemTextButton, altColorTheme && styles.altSettingsItemTextButton, styles.itemSelected]} >
                                    <LinearGradient
